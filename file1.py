...
def cmds_command(message):
    ...
    plan_line = "⭐ <b>VIP MEMBER</b>  ·  Active" if is_vip else "🆓 <b>FREE PLAN</b>  ·  <a href='https://t.me/yadistan'>Upgrade →</a>"

    gw_msg = (
        "<b>┌─────────────────────────────┐\n"
        "│  ⚡  ST-CHECKER-BOT  ⚡      │\n"
        "│   Premium CC Checker Suite   │\n"
        "└─────────────────────────────┘</b>\n\n"
        f"👤 <b>{name}</b>  ·  {plan_line}\n"
        f"💵 Charge Amount: <code>${current_amount}</code>\n\n"
        ...
        "         <i>└ 4111|12|25|123</i>\n"
        "📦 /chkm  Mass Checker\n"
        "         <i>└ up to 50 · reply .txt</i>\n\n"

        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        f"{lock} <b>PAYMENT GATEWAYS</b>  <i>· VIP</i>\n"
        "▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔\n"
        "🛒 /sp    <b>Shopify v5</b>  <i>· real checkout · auto-product</i>\n"
        "         <i>└ /sp https://store.com card</i>\n"
        "🔵 /wcs   <b>WooCommerce Stripe</b>  <i>· $0 auth</i>\n"
        "         <i>└ /wcs https://site.com card</i>\n"
        "🟢 /b3    <b>Braintree $0 Auth</b>  <i>· bandc gate · no charge</i>\n"
        "🛡️ /vbv   <b>Braintree 3DS</b>  <i>· $2.00 auth · single</i>\n"
        "🛡️ /vbvm  <b>Braintree 3DS Mass</b>  <i>· up to 500 cards</i>\n"
        f"💰 /pp    <b>PayPal</b>  <i>· charge ${current_amount}</i>\n"
        "⚡ /st    <b>Stripe Charge</b>  <i>· direct · ultra fast</i>\n"
        "🔐 /sa    <b>Stripe Auth</b>  <i>· $0 · no charge</i>\n"
        "🚀 /stm   <b>Stripe Mass</b>  <i>· multiple cards</i>\n"
        "🌐 /co    <b>Stripe Checkout</b>  <i>· 4-in-1 · BIN gen · .txt</i>\n"
        "🔗 /xco   <b>Ext API Checkout</b>  <i>· 4-in-1 · BIN gen · .txt</i>\n"
        "🎯 /h     <b>Hitter</b>  <i>· 4-in-1 · gold-newt hitter.php</i>\n"
        "🔥 /ah    <b>Auto Hitter</b>  <i>· 4-in-1 · invoice/checkout/billing</i>\n\n"

        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        f"{lock} <b>STRIPE SK CHECKERS</b>  <i>· VIP</i>\n"
        "▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔\n"
        "🗝️ /sk     Single  <i>└ /sk sk_live_xxx card</i>\n"
        "📦 /skm    Mass    <i>└ /skm sk_live_xxx cards</i>\n"
        "✅ /skchk  Inspector  <i>└ balance · charges · limits</i>\n"
        "🔎 /msk    Mass SK Keys  <i>└ up to 30 keys</i>\n\n"

        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "🆓 <b>CARD &amp; BIN TOOLS</b>\n"
        "▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔\n"
        "🎰 /gen    Generator  <i>└ /gen 411111 [qty]</i>\n"
        "🔎 /bin    BIN Lookup  <i>└ brand · bank · country</i>\n"
        "✅ /thik   CC Aligner  <i>└ raw → num|mm|yy|cvv</i>\n\n"

        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "🆓 <b>PROXY TOOLS</b>\n"
        "▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔\n"
        "➕ /addproxy  Set  ·  ➖ /removeproxy  Remove\n"
        "✅ /proxycheck  Test  ·  🕷️ /scr  Scrape\n"
        "⚡ /chkpxy  Bulk Check  <i>└ 10 threads · max 500</i>\n\n"

        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "⚙️ <b>SETTINGS &amp; INFO</b>\n"
        "▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔\n"
        f"💵 /setamount  <i>└ now ${current_amount}</i>  ·  📜 /history\n"
        f"🔑 /setsk {lock}  ·  👁️ /mysk {lock}  ·  🗑️ /delsk {lock}\n"
        "📡 /ping  ·  🆔 /myid  ·  🏷️ /redeem\n"
        f"{admin_section}\n"
        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "        ⌤ <b>Dev by @yadistan</b> 🍀"
